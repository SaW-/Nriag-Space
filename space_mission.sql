...
--
-- Host: localhost
-- Generation Time: Apr 26, 2017 at 11:14 PM
...
CREATE TABLE `sattalites` (
  ...
  `data_file` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sattalites` (`id`, `title`, `description`, `data_file`, `created_at`, `updated_at`) VALUES
(1, 'Orbital', 'sfwsw', 'wer', '2017-04-26 15:37:19', '2017-04-26 15:37:19');
