        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Sattalites</div>
                    <div class="panel-body">
                        <a href="{{ url('/App/sattalites/create') }}" class="btn btn-success btn-sm" title="Add New Sattalite">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/App/sattalites', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Title</th><th>Description</th><th>Data File</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
